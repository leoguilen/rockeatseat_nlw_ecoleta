            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4, connection_1.default('points')
                    ...
                    case 1:
                        ...
                        serializedPoints = points.map(function (point) {
                            return __assign(__assign({}, point), { image_url: "https://apiecoletav1.herokuapp.com/uploads/" + point.image });
                        });
                        return [2, res.json(serializedPoints)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        serializedPoint = __assign(__assign({}, point), { image_url: "https://apiecoletav1.herokuapp.com/uploads/" + point.image });
                        return [4, connection_1.default('items')
    ...
    PointsController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                connection_1.default.transaction(function (trx) { return __awaiter(_this, void 0, void 0, function () {
                    var point, insertedIds, point_id_1, pointItems, err_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                point = {
                            ...
                            case 1:
                                _a.trys.push([1, 4, , 5]);
                                return [4, trx('points').insert(point)];
                            case 2:
                                insertedIds = _a.sent();
                                ...
                                return [4, trx('point_items').insert(pointItems)];
                            case 3:
                                _a.sent();
                                return [2, res.json(__assign({ id: point_id_1 }, point))];
                            case 4:
                                err_1 = _a.sent();
